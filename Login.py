...
image2 = Image.open('C:/Users/hp/OneDrive/Desktop/Anuj IMP/BE IT PROJEC 2023/fake currency 100% code/bg7.PNG')
...
#
label_l1 = tk.Label(root, text="___FAKE CURRENCY DETECTION SYSTEM___",font=("Times New Roman", 30, 'bold'),
                    background="#36013F", fg="white", width=62, height=2)
...
title=tk.Label(root, text="USER LOGIN", font=("Times new roman", 30, "bold","italic"),bd=5,bg="white",fg="black")
title.place(x=621,y=185,width=250)
...
button1 = tk.Button(root, text="HOME", command=home, width=12, height=1,font=('times 15 bold underline'),bd=0, bg="white", fg="Blue")
button1.place(x=185, y=250)

button2 = tk.Button(root, text="REGISTER",command=reg,width=12, height=1,font=('times 15 bold underline'), bd=0,bg="white", fg="Blue")
button2.place(x=185, y=350)

button4 = tk.Button(root, text="EXIT", command=window, width=12, height=1,font=('times 15 bold underline'),bd=0,bg="white", fg="Blue")
