...
root.title("Fake Currency Detection System Using Machine Learning")
...
label_l1 = tk.Label(root, text="Fake Currency Detection System ",font=("Times New Roman", 30, 'bold'),
                    background="#16E2F5", fg="black", width=62, height=2)
...
frame_alpr = tk.LabelFrame(root, text=" --Register-- ", width=600, height=580, bd=5, font=('times', 14, ' bold '),fg="black",bg="#DAEE01")
...
btn = tk.Button(frame_alpr, text="Register", bg="#800080",font=("times new roman",20,"bold"),fg="white", width=9, height=1, bd=5,command=insert)
...
button1 = tk.Button(root, text="HOME", command=con, width=12, height=1,font=('times 15 bold underline'),bd=0, bg="#E9AB17", fg="white")
button1.place(x=235, y=250)

button2 = tk.Button(root, text="LOGIN",command=log,width=12, height=1,font=('times 15 bold underline'), bd=0,bg="#FF00FF", fg="white")
button2.place(x=235, y=350)

button4 = tk.Button(root, text="EXIT", command=window, width=12, height=1,font=('times 15 bold underline'),bd=0,bg="#800080", fg="white")
button4.place(x=235, y=450)




label_l1 = tk.Label(root, text="** Fake Currency Detection System Using Machine Learning @ 2021 by **",font=("Times New Roman", 10, 'bold'),
